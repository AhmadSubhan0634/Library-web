...
- Routes are not yet gated by login state — any visitor can still reach `/books/create`, `/books/edit`, etc. regardless of session status. Restricting these to logged-in users is Assignment 6.
